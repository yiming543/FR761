# 1 "D:\\yiming\\00work\\FR761_V05_test2.X\\timer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "D:\\yiming\\00work\\FR761_V05_test2.X\\timer.c" 2
...
extern flag_t ORB;
# 8 "D:\\yiming\\00work\\FR761_V05_test2.X\\timer.c" 2

# 1 "D:\\yiming\\00work\\FR761_V05_test2.X\\cmake\\FR761\\default.production\\..\\..\\../gpio.h" 1
# 11 "D:\\yiming\\00work\\FR761_V05_test2.X\\cmake\\FR761\\default.production\\..\\..\\../gpio.h"
...
# 11 "D:\\yiming\\00work\\FR761_V05_test2.X\\cmake\\FR761\\default.production\\..\\..\\../gpio.h" 2
...
# 9 "D:\\yiming\\00work\\FR761_V05_test2.X\\timer.c" 2
...
void Timer4(void){
  ...
  if(T1ms_cnt>=5){
    ...
    uint8_t temp=0;
    if(PORTCbits.RC1==1) temp|=1<<ePOS;
    if(PORTAbits.RA6==1) temp|=1<<eDRL;
    if(PORTCbits.RC2==1) temp|=1<<eTurn;
    if(PORTCbits.RC3==1) temp|=1<<eHiBeam;
    if(PORTAbits.RA3==1) temp|=1<<eLoBeam;
    if(PORTCbits.RC0==1) temp|=1<<eACC;
